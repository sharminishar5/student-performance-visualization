...
page = st.sidebar.selectbox(
    "Navigate Pages",
    [
        "Objective 1: Distribution of Academic & Non-Academic Factors",
        "Objective 2: Study Patterns, Attendance, and CGPA",
        "Objective 3: Correlation Among Key Academic Factors"
    ],
)
...
if page.startswith("Objective 1"):
    ...
    render_block(
        "Obj1_F1.png",
        "Figure 1. Distribution of CGPA According to Gender",
    ...
    render_block(
        "Obj1_F2.png",
        "Figure 2. Daily Study Hours vs Current CGPA by Gender",
    ...
    render_block(
        "Obj1_F3.png",
        "Figure 3. Effect of Class Attendance on CGPA",
...
# ===========================
    ...
    render_block(
        "Obj2_F1.png",
        "Figure 1. Daily Study Hours vs Current CGPA",
    ...
    render_block(
        "Obj2_F3.png",
        "Figure 3. Study Sessions per Day vs Current CGPA",
...
# ===========================
    ...
    render_block(
        "Obj3_F1.png",
        "Figure 1. Correlation Between Academic and Behavioral Factors",
    ...
    render_block(
        "Obj3_F2.png",
        "Figure 2. Family Income vs Current CGPA",
    ...
    render_block(
        "Obj3_F3.png",
        "Figure 3. Scholarship Status vs CGPA",
